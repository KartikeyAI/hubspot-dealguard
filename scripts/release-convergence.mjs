...
const expectedMigrationNumbers = Array.from({ length: 26 }, (_, index) => index + 1);
record(
  'PostgreSQL migration sequence is contiguous through 0026',
...
const result = {
  ...
  migrationRange: { first: '0001', last: '0026', releaseStart: '0015', releaseEnd: '0022' },
