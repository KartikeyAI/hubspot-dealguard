...
const expectedMigrationNumbers = Array.from({ length: 28 }, (_, index) => index + 1);
record(
  'PostgreSQL migration sequence is contiguous through 0028',
...
const result = {
  ...
  migrationRange: { first: '0001', last: '0028', releaseStart: '0015', releaseEnd: '0022' },
