...
const expectedMigrationNumbers = Array.from({ length: 29 }, (_, index) => index + 1);
record(
  'PostgreSQL migration sequence is contiguous through 0029',
...
const result = {
  ...
  migrationRange: { first: '0001', last: '0029', releaseStart: '0015', releaseEnd: '0022' },
