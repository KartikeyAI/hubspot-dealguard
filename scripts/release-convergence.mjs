...
const expectedMigrationNumbers = Array.from({ length: 24 }, (_, index) => index + 1);
record(
  'PostgreSQL migration sequence is contiguous through 0024',
...
const result = {
  ...
  migrationRange: { first: '0001', last: '0024', releaseStart: '0015', releaseEnd: '0022' },
