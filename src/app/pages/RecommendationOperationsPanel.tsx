    ...
    <Flex direction="column" gap="small">
      ...
      {canFollowup ? <Flex direction="column" gap="small">
        <Flex direction="row" gap="small" wrap="wrap">
          <Select name="recommendation-followup-kind" label="Follow-up type" value={kind} options={[{ label: 'Owner reminder', value: 'owner_reminder' }, { label: 'Manager review', value: 'manager_review' }]} onChange={(value: string) => { setKind(value as FollowupKind); setPreview(null); }} />
          <Select name="recommendation-followup-severity" label="Severity" value={severity} options={[{ label: 'Warning', value: 'warning' }, { label: 'Critical', value: 'critical' }]} onChange={(value: string) => { setSeverity(value as Severity); setPreview(null); }} />
        </Flex>
