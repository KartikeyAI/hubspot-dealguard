...
export type DealGuardQueueMessage =
  ...
  | { version: 1; kind: 'maintenance'; task: 'webhook_events' | 'background_intelligence' | 'portfolio_snapshots' | 'remediation_escalation' | 'alert_escalation' | 'synthetics' | 'billing_schedule' | 'policy_exceptions' | 'retention' | 'audit_promotion' | 'secure_download_cleanup' | 'maintenance'; requestedAt: string };
